...
class RijndaelOpenSSL
{
    ...
    private string $pbkdfBase = '';
    private string $pbkdfExtra = '';
    private int $pbkdfExtracount = 0;
    private int $pbkdfHashno = 0;
    private int $pbkdfState = 0;
    ...
    public function encrypt($inputText, $password): string
    {
        $this->reset();
        $salt = (string) mb_strlen($password);
        $key = $this->pbkdf1($password, $salt, 32);
     ...
     */
    private function pbkdf1(string $pass, string $salt, int $countBytes)
    {

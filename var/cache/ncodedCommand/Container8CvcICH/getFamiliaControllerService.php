 ...
 */
class getFamiliaControllerService extends App_KernelNcodedCommandDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\FamiliaController'] = $instance = new \App\Controller\FamiliaController(($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService')), ($container->privates['App\\Service\\ConfigService'] ?? ($container->privates['App\\Service\\ConfigService'] = new \App\Service\ConfigService(($container->services['kernel'] ?? $container->get('kernel', 1))))), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));

 ...
 */
class get_Container_Private_TwigService extends App_KernelNcodedCommandDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f->setEnvironment('ncodedCommand');
        $f->setDebug(true);
        ...
        $instance->addExtension(new \App\Twig\AppExtension(($container->privates['App\\Service\\ConfigService'] ?? ($container->privates['App\\Service\\ConfigService'] = new \App\Service\ConfigService(($container->services['kernel'] ?? $container->get('kernel', 1)))))));

 ...
 */
class getRouting_LoaderService extends App_KernelNcodedCommandDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'ncodedCommand');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'ncodedCommand'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'ncodedCommand'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'ncodedCommand'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'ncodedCommand'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'ncodedCommand'));
